...
export async function cast(
  ...
  //@ts-ignore
  parsedQuery.serial = serial;
  //@ts-ignore
  parsedQuery.eventEmitter = eventEmitter;
  ...
  //   /// #if USE_QVH_SERVER
  //   const { StreamClientQVHack } = await import(
  //     './applDevice/client/StreamClientQVHack'
  //   );
  ...
  //   const { StreamClientMJPEG } = await import(
  //     './applDevice/client/StreamClientMJPEG'
  //   );
  ...
  //   if (
  //     action === StreamClientMJPEG.ACTION &&
  //     typeof parsedQuery.get('udid') === 'string'
  //   ) {
  ...
  // const { FileListingClient } = await import(
  //   './googDevice/client/FileListingClient'
  // );
